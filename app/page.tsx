...
export default function Home() {
  ...
  return (
    <main className="min-h-screen px-24 py-12 flex flex-col">
      <h1 className="text-5xl font-bold w-full text-center pb-8 mb-8 text-cyan-400 border-b">Book Store</h1>
      ...
      { 
        ...
        <div className="flex flex-col border p-6 gap-4 rounded-lg">
